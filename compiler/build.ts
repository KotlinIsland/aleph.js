import { encode } from 'https://deno.land/std@0.91.0/encoding/base64.ts'
...
if (import.meta.main) {
  if (await run(['wasm-pack', 'build', '--target', 'web'])) {
    ...
    await Deno.writeTextFile(
      './dist/wasm-pack.js',
      `import { red } from 'https://deno.land/std@0.91.0/fmt/colors.ts';` + wasmPackJS.replace('console.error(getStringFromWasm0(arg0, arg1));', `
